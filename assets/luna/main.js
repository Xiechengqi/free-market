!function (w) {
    ...
    let paySvgArr = {
        ...
        paypal     : paypal,
        wechat     : weChatSvg,
        stripe     : '<span class="payment-badge payment-badge-stripe">S</span>',
        ...
        trx        : '<span class="payment-badge payment-badge-trx">TRX</span>',
        "tron-usdt": '<span class="payment-badge payment-badge-usdt">USDT</span>',
        "tron-trx" : '<span class="payment-badge payment-badge-trx">TRX</span>',
        mgcoin     : otherSvg,
    ...
    $('.pay-type').each(function () {
        ...
        } else if (t.data('badge') !== undefined && t.data('badge') !== '') {
            t.append('<span class="payment-badge payment-badge-' + type + '">' + t.data('badge') + '</span> ' + name);
        } else {
